...
const menuCategories: MenuCategory[] = [
  {
    ...
    emoji: "🍕",
    items: [
      { id: 1, name: "Margarita", description: "Salsa de tomate casera, mozzarella y orégano", price: "$18.000", image: "/images/pizza_1.jpg" },
      { id: 2, name: "Pepperoni", description: "Pepperoni, mozzarella y salsa de tomate artesanal", price: "$22.000", image: "/images/pizza_2.jpg" },
      { id: 3, name: "Hawaiana", description: "Jamón, piña, mozzarella y salsa de la casa", price: "$25.000", image: "/images/pizza_3.jpg" },
      { id: 4, name: "Vegetariana", description: "Pimientos, champiñones, cebolla morada y aceitunas", price: "$24.000", image: "/images/pizza_4.jpg" },
      { id: 5, name: "Carnes", description: "Res, pollo, jamón y salchicha con doble queso", price: "$28.000", image: "/images/pizza_5.jpg" },
      { id: 6, name: "Familiar", description: "Grande para compartir, ingredientes a elección", price: "$55.000", image: "/images/pizza_6.jpg" },
    ],
  },
  {
    id: "lasana",
